...
export default function StockTaxonomyPanel({
  ...
  const input = 'w-full bg-page-bg border border-white/10 rounded p-2 text-white text-sm outline-none focus:border-accent';
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      {/* Storage locations */}
      <div className={card}>
        <h3 className="text-white font-black uppercase tracking-wider text-sm mb-3">Storage Locations</h3>
